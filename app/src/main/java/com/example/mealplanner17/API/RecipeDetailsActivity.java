...
public class RecipeDetailsActivity extends AppCompatActivity {
    ...
    Button btnFavorite;
    private TextView recipeDropdownTrigger;
    private LinearLayout recipeStepsContainer;
    private RecyclerView stepList;
    private RecyclerView recyclerSideOptions;
    private JuiceOptionsAdapter juiceOptionsAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Initialize views
        recipeDropdownTrigger = findViewById(R.id.recipeDropdownTrigger);
        recipeStepsContainer = findViewById(R.id.recipeStepsContainer);
        stepList = findViewById(R.id.stepList);
        recyclerSideOptions = findViewById(R.id.recycler_side_options);

        // Initialize the RecyclerView for recipe steps
        stepList.setLayoutManager(new LinearLayoutManager(this));

        // Initialize the RecyclerView for juice side options
        recyclerSideOptions.setLayoutManager(new LinearLayoutManager(this));
        recyclerSideOptions.setAdapter(juiceOptionsAdapter);

        // Set an onClick listener for the dropdown trigger
        recipeDropdownTrigger.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Toggle the visibility of the recipe steps container
                if (recipeStepsContainer.getVisibility() == View.GONE) {
                    recipeStepsContainer.setVisibility(View.VISIBLE);
                } else {
                    recipeStepsContainer.setVisibility(View.GONE);
                }
            }
        });
